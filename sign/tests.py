...
class ModelTest(TestCase):
    ...
    def setUp(self):
        Event.objects.create(id=11,name='one plus 3 event',status=True,limit=200,address='shenzhen',start_time='2016-8-31 02:12:22')
        Guest.objects.create(id = 11,event_id=11,realname='alen',phone = '13712356789',email='alen@mail.com',sign = False)
    ...
    def test_guest_models(self):
        result = Guest.objects.get(phone="13712356789")
