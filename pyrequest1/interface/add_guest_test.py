...
from pyrequest1.db_fixture import test_data
...
class AddGuestTest(unittest.TestCase):
    ...
    def test_add_guest_eid_null(self):
        ''' eid=901 查询为空 '''
        payload = {'eid':901,'realname':'tom','phone':13711001100,'email':'ss@mail.com'}
    ...
    def test_add_guest_status_close(self):
        ''' eid=2 状态未开启 '''
        payload = {'eid':3,'realname':'tom','phone':13711001100,'email':'ss@mail.com'}
        r = requests.post(self.base_url,data=payload)
        self.result = r.json()
    ...
    def test_add_guest_limit_full(self):
        ''' eid=2 发布会人数已满 '''
        payload = {'eid':2,'realname':'tom','phone':13711001100,'email':'ss@mail.com'}
        r = requests.post(self.base_url,data=payload)
        self.result = r.json()
    ...
    def test_add_guest_time_start(self):
        ''' eid=4 发布会已开始 '''
        payload = {'eid':4,'realname':'tom','phone':'13711001100','email':'ss@mail.com'}
        r = requests.post(self.base_url,data=payload)
        print(r)
        self.result = r.json()
    ...
    def test_add_guest_phone_repeat(self):
        ...
        payload = {'eid':1,'realname':'tom','phone':'13511001190','email':'ss@mail.com'}
        #r = requests.post(self.base_url,data=payload)
        r = requests.post(self.base_url, data=payload)
        print('345678')
        print(r)
    ...
    def test_add_guest_success(self):
        ''' 添加成功 '''
        payload = {'eid':1,'realname':'tom','phone':'13511001199','email':'ss@mail.com'}
        r = requests.post(self.base_url,data=payload)
        print(r)
        self.result = r.json()
